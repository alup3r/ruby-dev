RSpec.describe 'all pattern' do
  ...
  it 'test 5' do
    ...
    statuses.each do |item|
      all_busy = false unless item.is_a?(Symbol)
    end
  ...
  it 'test 7' do
    ...
    zip_codes.each do |digit|
      all_five_digits = false unless digit.to_s.length == 5
    end
  ...
  it 'test 9' do
    snacks = %w[GARLIC PLANTAINS SNICKERDOODLES Pretzels]
    # Your Code Here
    all_caps = true
    snacks.each do |word|
